...
import { Copy, FolderOpen, Globe2, Plus, Send, Server, ShieldCheck, Trash2, TriangleAlert } from "lucide-vue-next";
...
const logStreamRef = useTemplateRef<HTMLDivElement>("logStreamRef");
